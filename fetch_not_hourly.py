"""Fetch Notcoin (NOT) hourly OHLC from CoinMarketCap data-api.

Same chunking strategy as fetch_bonk_hourly.py. NOT id=28850, USD convertId=2781.
NOT TGE 2024-05-16 — start from 2024-05-15 to be safe.
"""
import urllib.request, json, time, datetime as dt, os, sys

CMC_ID = 28850          # Notcoin
CONVERT_ID = 2781       # USD
OUT = os.path.join(os.path.dirname(__file__), 'data', 'not_hourly.json')

START = dt.datetime(2024, 5, 15, 0, 0, tzinfo=dt.timezone.utc)
