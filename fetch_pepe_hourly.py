"""Fetch PEPE hourly OHLC from CoinMarketCap data-api in 400-hour chunks.

Range: 2024-02-21 → 2024-04-16 UTC (PEPE Q1 2024 rally penceresi).
"""
import urllib.request, json, time, datetime as dt, os, sys

CMC_ID = 24478          # PEPE
CONVERT_ID = 2781       # USD
OUT = os.path.join(os.path.dirname(__file__), 'data', 'pepe_hourly.json')

START = dt.datetime(2024, 2, 21, 0, 0, tzinfo=dt.timezone.utc)
END   = dt.datetime(2024, 4, 16, 23, 0, tzinfo=dt.timezone.utc)
