...
import { applyStaticLabels, setUILang, T } from './i18n.js?v=30';
import {
    appInfo, setCountry, setFilterOpen, setPlatform, setRating,
} from './state.js?v=30';
import { els } from './dom.js?v=30';
import { loadReviews } from './api.js?v=30';

import { renderLangToggle } from './render/lang-toggle.js?v=30';
import { renderRatingBtns } from './render/rating-btns.js?v=30';
import {
...
} from './render/filter-dropdown.js?v=30';
import { renderActiveChips } from './render/active-chips.js?v=30';
import { renderReviews, toggleDetails } from './render/cards.js?v=30';
import { renderArchive, archivePrev, archiveNext, selectDate } from './render/archive.js?v=30';
import { renderFooter } from './render/footer.js?v=30';
import { openInsights, closeInsights, setInsightsPeriod, onLangChange as onInsightsLangChange } from './insights.js?v=30';
